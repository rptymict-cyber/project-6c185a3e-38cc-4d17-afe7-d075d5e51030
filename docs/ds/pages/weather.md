...
| DS-0801 | 날씨 상세 | WTR-001_weather_Default | Tracking | - | Registry: docs/ds/screen-registry.json<br>Route: /weather<br>File: src/routes/weather.tsx<br>Baseline: 2026-07-31 코드 기준 |
