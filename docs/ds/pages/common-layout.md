...
| DS-1105 | 공통 상단바(GNB) | LAY-003_app-header_Default | Tracking | - | Registry: docs/ds/screen-registry.json<br>Route: Parent=/<br>File: src/components/app-header.tsx<br>Baseline: 2026-08-05 코드 기준<br>⚠️ 확인 필요: 새로고침·검색·알림 버튼에 대한 별도 분석 이벤트 로깅 코드는 확인되지 않음 |
