    ...
    <section>
      <div className="grid grid-cols-3 gap-2">
        ...
        <div className="rounded-[13px] border border-[#E9ECEF] bg-white p-2.5 text-center">
          <div className="text-meta font-bold text-[#E8590C]">▲ 낙관</div>
        ...
        <div className="relative rounded-[13px] border-2 border-[#2E9E6B] bg-[#F0F9F0] p-2.5 pt-3.5 text-center">
          <span className="absolute left-1/2 top-[-9px] -translate-x-1/2 whitespace-nowrap rounded-full bg-[#2E9E6B] px-2 py-[2px] text-meta font-extrabold text-white">
            가장 가능성 높음
          </span>
          <div className="text-meta font-bold text-[#1F5C1F]">● 중립</div>
          <div className="mt-1 flex items-baseline justify-center gap-0.5">
          ...
          <div className="mt-0.5 text-meta font-bold text-[#1F5C1F]">기준</div>
        </div>
        {/* 비관 */}
        <div className="rounded-[13px] border border-[#E9ECEF] bg-white p-2.5 text-center">
          <div className="text-meta font-bold text-[#1971C2]">▼ 비관</div>
          <div className="mt-1 flex items-baseline justify-center gap-0.5">
            <span className="text-subtitle font-black tabular-nums text-foreground">
              {pess.toLocaleString()}
            </span>
