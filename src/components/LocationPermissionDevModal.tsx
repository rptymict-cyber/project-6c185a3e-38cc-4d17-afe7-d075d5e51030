    ...
    >
      <DialogContent className="w-[300px] rounded-2xl p-0">
        <div className="px-5 pt-5 pb-4 text-center">
          ...
          <h2 className="mt-3 text-body-lg font-bold text-foreground">
            현재 위치 정보를 사용할까요?
          </h2>
          <p className="mt-1.5 text-caption leading-[18px] text-muted-foreground">
            가까운 도매시장과 현재 위치 날씨를 안내하는 데 사용됩니다.
          </p>
          <p className="mt-3 rounded-[10px] bg-[#F8F9FA] px-3 py-2 text-meta leading-[17px] text-[#6C757D]">
