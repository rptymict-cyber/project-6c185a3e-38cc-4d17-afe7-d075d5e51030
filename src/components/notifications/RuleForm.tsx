...
export function RuleForm({
  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-x-0 bottom-[calc(64px+env(safe-area-inset-bottom))] z-30 mx-auto w-full max-w-[430px] border-t border-[#E9ECEF] bg-background px-4 pb-3 pt-3">
