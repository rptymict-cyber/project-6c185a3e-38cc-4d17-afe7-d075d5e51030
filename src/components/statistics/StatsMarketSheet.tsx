    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="bottom" className="max-h-[80vh] rounded-t-2xl p-0">
        <div className="flex items-center justify-between px-4 pt-4 pb-2">
          <h3 className="text-subtitle font-black">시장 선택</h3>
        </div>

        {warn && (
          <div className="mx-4 mb-2 flex items-center gap-2 rounded-[10px] bg-[#FFF4E6] px-3 py-2 text-caption text-[#B76E00]">
        ...
        <div className="border-t border-[#E9ECEF] p-4">
          <button
            ...
            className="w-full rounded-[12px] bg-[#3A8A3A] py-3 text-body font-black text-white active:bg-[#2F6F2F]"
          >
            적용
          </button>
        </div>
