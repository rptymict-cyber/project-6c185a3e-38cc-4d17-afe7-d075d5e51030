...
export function VolumeByMarketTab({
  ...
  return (
    <div className="pb-8">
      ...
      <div className="mx-4 mt-3 rounded-[10px] border border-[#E9ECEF] bg-white px-3 py-4">
        <div className="relative mx-auto h-[200px] w-full">
          ...
          <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center">
            <div className="text-heading font-black tabular-nums text-foreground">
              {stats.total.toFixed(1)}t
            </div>
            <div className="mt-0.5 text-meta text-[#868E96]">총 거래량</div>
          </div>
        </div>
          ...
          {stats.breakdown.map((b, i) => {
            ...
            return (
              ...
              >
                ...
                <span className="shrink-0 text-caption tabular-nums text-[#495057]">
      ...
      <div className="mt-4 mx-4 rounded-[10px] border border-[#E9ECEF] bg-[#F8F9FA] px-3 py-2.5 text-meta text-[#6C757D]">
  ...
  return (
    <div className="rounded-[10px] border border-[#E9ECEF] bg-white px-2 py-2">
      ...
      <div
        className={
          small
            ? "mt-1 truncate text-caption font-black tabular-nums leading-tight text-foreground"
            : "mt-1 text-body font-black tabular-nums leading-tight text-foreground"
        }
      >
        {value}
      </div>
