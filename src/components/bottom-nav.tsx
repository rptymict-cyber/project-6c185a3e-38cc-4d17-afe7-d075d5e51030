    ...
    >
      {tabs.map(({ to, label, Icon, showUnread }) => (
        <Link
          ...
          className="group flex min-h-11 flex-1 flex-col items-center justify-center gap-1 text-meta text-[#9CA3AF] transition-colors data-[status=active]:text-primary"
        >
