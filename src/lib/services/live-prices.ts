...
const POOL: LivePriceRow[] = [
  ...
  { id: "greenonion", name: "대파", market: "대전오정", unit: "1kg단", pricePerKg: 1980, changePct: 4.8, volumeTon: 186.7 },
  ...
  { id: "cucumber", name: "오이", market: "광주각화", unit: "50개", pricePerKg: 2260, changePct: 5.4, volumeTon: 142.5 },
  ...
  { id: "spinach", name: "시금치", market: "광주각화", unit: "4kg박스", pricePerKg: 3960, changePct: -5.8, volumeTon: 62.3 },
  ...
  { id: "lettuce", name: "상추", market: "광주각화", unit: "2kg박스", pricePerKg: 4720, changePct: 6.8, volumeTon: 42.1 },
  { id: "pepper", name: "피망", market: "광주각화", unit: "5kg박스", pricePerKg: 5320, changePct: -3.6, volumeTon: 38.4 },
